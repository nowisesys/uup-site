...
{
        return array("mailto"    => array("href" => "yourname@domain.com",
                        "name" => "Your Name"),
                "webmaster" => array("href" => "http://www.doamin.com/webmaster.php",
                        "name" => "Webmaster"),
                "published" => 2008,
                "modified"  => getlastmod()
        );
...
function print_body()
{
        echo "<h1>Header text</h1>\n";
        echo "<p>This is the page body content.</p>\n";
}
